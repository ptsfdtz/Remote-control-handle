...
/*
  void redo_right() {
    analogWrite(M1_Speed, 80);  //控制电机的速度，不同的车模，代码执行效果不同！
    analogWrite(M2_Speed, 140);  //控制电机的速度，不同的车模，代码执行效果不同！
    analogWrite(M3_Speed, 80);  //控制电机的速度，不同的车模，代码执行效果不同！
    analogWrite(M4_Speed, 140);  //控制电机的速度，不同的车模，代码执行效果不同！
    digitalWrite(L1_IN1, HIGH);
    digitalWrite(L1_IN2, LOW);
    digitalWrite(R1_IN1, HIGH);
    digitalWrite(R1_IN2, LOW);
  ...
  void redo_left() {
    analogWrite(M1_Speed, 140);  //控制电机的速度，不同的车模，代码执行效果不同！
    analogWrite(M2_Speed, 80);  //控制电机的速度，不同的车模，代码执行效果不同！
    analogWrite(M3_Speed, 140);  //控制电机的速度，不同的车模，代码执行效果不同！
    analogWrite(M4_Speed, 80);  //控制电机的速度，不同的车模，代码执行效果不同！
    digitalWrite(L1_IN1, HIGH);
    digitalWrite(L1_IN2, LOW);
    digitalWrite(R1_IN1, HIGH);
    digitalWrite(R1_IN2, LOW);
